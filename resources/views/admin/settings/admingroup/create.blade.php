@extends('layouts.app')
@section('title', 'Add Admin Group')
@section('page-title', 'Add Admin Group')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" id="form" action="{{ route('adminGroups.store') }}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory">
                                        ...
                                        <select name="admin_group_category_id" id="admin_group_category_id"
                                            ...
                                            @foreach ($admin_group_categories as $admin_group)
                                                <option value="{{ $admin_group->id }}"
                                                    {{ old('admin_group_category_id') == $admin_group->id ? 'selected' : '' }}>
