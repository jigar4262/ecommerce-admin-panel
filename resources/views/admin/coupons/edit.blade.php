                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                            <form method="POST" class="form" action="{{ route('coupons.update', $coupon->id) }}"
                                id="couponForm">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="text" id="min_order_amt"
                                                ...
                                                value="{{ old('min_order_amt', $coupon->min_order_amt) }}" />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mandatory">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <select name="apply_coupon_on" id="apply_coupon_on"
                                                ...
                                                <option value="all"
                                                    {{ old('apply_coupon_on', $coupon->apply_coupon_on) == 'all' ? 'selected' : '' }}>
                                                    All Products
                                                </option>
                                                <option value="category"
                                                    {{ old('apply_coupon_on', $coupon->apply_coupon_on) == 'category' ? 'selected' : '' }}>
                                                    Selected
                                                    Categories</option>
                                                <option value="product"
                                                    {{ old('apply_coupon_on', $coupon->apply_coupon_on) == 'product' ? 'selected' : '' }}>
                                                    Selected
                                                    Products</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <select name="is_login_required" id="is_login_required"
                                                ...
                                                <option value="yes"
                                                    {{ old('is_login_required', $coupon->is_login_required) == 'yes' ? 'selected' : '' }}>
                                                    Yes</option>
                                                <option value="no"
                                                    {{ old('is_login_required', $coupon->is_login_required) == 'no' ? 'selected' : '' }}>
                                                    No</option>
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select name="product_id[]" id="product_id"
                                                ...
                                                @foreach ($products as $product)
                                                    <option value="{{ $product->id }}"
                                                        {{ in_array($product->id, old('product_id', $coupon->products->pluck('id')->toArray())) ? 'selected' : '' }}>
                                                        {{ $product->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select name="category_id[]" id="category_id"
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        {{ in_array($category->id, old('category_id', $coupon->categories->pluck('id')->toArray())) ? 'selected' : '' }}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Description" id="description" name="description">{{ old('description', $coupon->description) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
        ...
        $(document).ready(function() {
            ...
            $('#apply_coupon_on').on('change', function() {
                ...
                if ($(this).data('changed')) {
                    alert('changed');
                    $('#category_id, #product_id').val('').trigger('change');
                }
