...
@section('content')
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="form-group mandatory">
                                            ...
                                            <select name="option_type_id" id="option_type_id"
                                                ...
                                                <option value="select"
                                                    {{ old('option_type_id') == 'select' ? 'selected' : '' }}>
                                                    Select</option>
                                                <option value="radio"
                                                    {{ old('option_type_id') == 'radio' ? 'selected' : '' }}>
                                                    Radio</option>
                                                <option value="checkbox"
                                                    {{ old('option_type_id') == 'checkbox' ? 'selected' : '' }}>
                                                    Checkbox</option>
                                                <option value="text"
                                                    {{ old('option_type_id') == 'text' ? 'selected' : '' }}>
                                                    Text</option>
                                                <option value="textarea"
                                                    {{ old('option_type_id') == 'textarea' ? 'selected' : '' }}>
                                                    Textarea</option>
                                                <option value="file"
                                                    {{ old('option_type_id') == 'file' ? 'selected' : '' }}>
                                                    File</option>
                                                <option value="date"
                                                    {{ old('option_type_id') == 'date' ? 'selected' : '' }}>
                                                    Date</option>
                                            </select>
    ...
    <script>
        $(document).ready(function() {
            ...
            let index = {{ count(old('option_values', [['value' => '', 'image' => '', 'sort_order' => '']])) }};
      
            let _type = $('#option_type_id').val();
            if (['select', 'radio', 'checkbox'].includes(_type)) {
            ...
            $('#option_type_id').change(function() {
                ...
                $('#option_tb tbody').html(`<tr>
                    <td><input type="text" name="option_values[0][value]" class="form-control value-input"></td>
            ...
            $(document).on('click', '.addrow', function() {
                var newrow = `<tr>
                    <td><input type="text" name="option_values[${index}][value]" class="form-control value-input"></td>
